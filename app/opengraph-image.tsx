  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        <div style={{ marginTop: 24, fontSize: 28, color: "#525252", maxWidth: 900, lineHeight: 1.4 }}>{siteConfig.tagline}</div>
        <div style={{ marginTop: 48, fontSize: 20, fontFamily: "ui-monospace, monospace", color: primary }}>
