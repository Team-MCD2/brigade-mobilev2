...
/**
 * Rayons : boutons volontairement “sharp” (rounded-sm / coins resserrés sur xs–sm)
 * pour contraster avec les surfaces (Card, Input, menus) qui suivent --radius / rounded-lg+.
 */
